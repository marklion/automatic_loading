...
enum AD_RPC_SERVER_PORTS
{
    ...
    AD_RPC_HHT_SERVER_PORT = 46007,
    AD_RPC_PLATE_GATE_SERVER_PORT = 46008,
    AD_RPC_SCALE_SERVER_PORT = 46009,
    AD_RPC_DROP_SYSTEM_SERVER_PORT = 46010,
};
...
enum AD_BUSSINESS_SERVER_PORTS
{
    ...
    AD_BUSINESS_PROMPT_SERVER_PORT = 47001,
};
