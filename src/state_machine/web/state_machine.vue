<template>
    <div v-if="should_show">
        <el-descriptions title="运行状态" :column="3" border>
            <template #extra>
                <el-button v-if="!isRecording" type="success" @click="my_startAudioStreaming">广播</el-button>
                <el-button v-else type="danger" @click="my_stopAudioProcessing">停止</el-button>
